...
def test_multiple_numbers():
    pdf_path = r"C:\Users\hiand\Documents\UChicago\Interview\K1X\Files\Test_Document_4.pdf"
...
def test_no_line_number():
    pdf_path = r"C:\Users\hiand\Documents\UChicago\Interview\K1X\Files\Test_Document_5.pdf"
    total_sum = read_and_sum("Test with No Line Number", pdf_path)
    assert total_sum == 116, "test_no_line_number failing"

# All test mixed in one
def test_all():
    pdf_path = r"C:\Users\hiand\Documents\UChicago\Interview\K1X\Files\Test_Document_6.pdf"
